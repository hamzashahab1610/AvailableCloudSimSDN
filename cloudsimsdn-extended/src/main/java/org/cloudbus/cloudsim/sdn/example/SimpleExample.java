...
public class SimpleExample {
  ...
  protected static SDNDatacenter createSDNDatacenter(String name, String physicalTopology, NetworkOperatingSystem snos,
   ...
   * this.groupFilenameStart+this.groupFileNum; fileId++) {
   ...
   * int groupFileNum) {
   * return new WorkloadGroup(autoIdGenerator++, groupFilenamePrefix,
   * groupFileNum, 0);
   * }
   * public static WorkloadGroup createWorkloadGroup(String groupFilenamePrefix,
   * int groupFileNum, int groupFilenameStart) {
   * return new WorkloadGroup(autoIdGenerator++, groupFilenamePrefix,
   * groupFileNum, groupFilenameStart);
   * }
   * }
   * 
