...
public class VirtualTopologyGeneratorVmTypesSFC extends VirtualTopologyGeneratorVmTypes {
  ...
  public void generateVMGroupComplex(int numWeb, int numApp, int numDB, TimeGen startTime, TimeGen endTime, Long linkBw,
  ...
  public SFSpec addSFFirewall(String name, long linkBw, TimeGen startTime, TimeGen endTime, boolean noscale) {
    ...
    SFSpec sf = addSF(name, pes, mips, ram, storage, bw, startTime.getStartTime(), endTime.getEndTime(), miPerOperation,
        "Firewall");
