...
public class Configuration {
  ...
  /*
   * /////////////////////////////////FOR TEST ONLY
   * public static final double monitoringTimeInterval = 1; // every 60 seconds,
   * polling utilization.
   * 
   * public static final double overbookingTimeWindowInterval =
   * monitoringTimeInterval; // Time interval between points
   * public static final double overbookingTimeWindowNumPoints = 5; // How many
   * points to track
   * 
   ...
   * public static final double OVERLOAD_THRESHOLD_ERROR = 1.0 -
   * OVERLOAD_THRESHOLD;
   ...
   * more than historical utilization
   * public static final double OVERLOAD_HOST_PERCENTILE_THRESHOLD = 0.3; // If 5%
   * of time is overloaded, host is overloaded
   * 
   ...
   * public static final double monitoringTimeInterval = 180; // every 60 seconds,
   * polling utilization.
   * 
   * public static final double overbookingTimeWindowInterval =
   * monitoringTimeInterval; // Time interval between points
   ...
   * (OVERBOOKING_RATIO_MAX - OVERBOOKING_RATIO_MIN)*0.2;
   * public static final double OVERLOAD_HOST_PERCENTILE_THRESHOLD = 0.3; // If 5%
   * of time is overloaded, host is overloaded
   * 
  ...
  public static final double CPU_REQUIRED_MIPS_PER_WORKLOAD_PERCENT = 1.0;// 0.05; // 20% of CPU resource is required to
                                                                          // process 1 workload
  ...
  public static final double TIME_OUT = Double.POSITIVE_INFINITY;
  ...
  public static double CHECKPOINT_OVERHEAD = 20;
