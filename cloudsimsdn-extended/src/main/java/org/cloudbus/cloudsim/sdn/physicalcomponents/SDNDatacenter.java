...
public class SDNDatacenter extends Datacenter {
  protected String placementsFile;
  private NetworkOperatingSystem nos;
  protected HashMap<Integer, Request> requestsTable = new HashMap<Integer, Request>();
  protected static HashMap<Integer, Datacenter> globalVmDatacenterMap = new HashMap<Integer, Datacenter>();
  ...
  protected void processCloudletFailed(Cloudlet cl) {
  ...
  protected void processPacketFailed(Packet pkt) {
  ...
  protected void processNextActivity(Request req) {
  ...
  public String isSplitJoin() {
    return placementsFile.contains("split-join") ? "split-join" : "serial";
  }

  public String isEdgeCloud() {
    return placementsFile.contains("edge") ? "edge" : "cloud";
  }
