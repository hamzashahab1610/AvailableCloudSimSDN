...
public class PowerUtilizationEnergyModelSwitchActivePort implements PowerUtilizationEnergyModel {
  ...
  /*
   * based on CARPO: Correlation-Aware Power Optimization in Data Center Networks
   * by Xiaodong Wang et al.
   */

  private final double pStatic;
  private final double pPort;
  ...
  public PowerUtilizationEnergyModelSwitchActivePort() {
    this(66.7, 1.0); // Default values from CARPO paper
  }

  public PowerUtilizationEnergyModelSwitchActivePort(double pStatic, double pPort) {
